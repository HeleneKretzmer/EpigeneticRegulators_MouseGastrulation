...
data <- read.table('ED5a_RepeatFamily_methylation.tsv', header=T)
...
data <- read.table('ED5a_RepeatFamily_expression.tsv', header=T)
...
data <- read.table('ED5e_L3mbtl2_hypo_derepr_genes_methylation.tsv', header=T, row.names=1)
...
data <- read.table('ED5e_L3mbtl2_hypo_derepr_genes_pos_cells.tsv', header=T)
