...
data <- read.table('PCG_dist_to_CellState.tsv', header=T)
...
data <- read.table('CDKN2A_85_Cdkn2a_statistics.tsv', header=T)
data <- read.table('EED.CDKN2A_85_Cdkn2a_statistics.tsv', header=T)
data <- read.table('EED.CDKN2A_85_Eed_statistics.tsv', header=T)
...
data <- read.table('CellStateProportion_correlation_Eed_Cdkn2a.tsv', header=T, row.names=1)
