...
data <- read.table('KO_expression_in_WT_per_stage.tsv', header=T)
...
data <- read.table('KO_expression_in_WT_per_lineage.tsv', header=T)
...
data <- read.table('DNMT1_85_statistics.tsv', header=T)
data <- read.table('DNMT3A_85_statistics.tsv', header=T)
data <- read.table('DNMT3B_85_statistics.tsv', header=T)
data <- read.table('G9A_85_statistics.tsv', header=T)
data <- read.table('EED_85_statistics.tsv', header=T)
data <- read.table('RNF2_85_statistics.tsv', header=T)
data <- read.table('KDM2B_85_statistics.tsv', header=T)
data <- read.table('L3MBTL2_85_statistics.tsv', header=T)
data <- read.table('KMT2A_85_statistics.tsv', header=T)
data <- read.table('KMT2B_85_statistics.tsv', header=T)
...
data <- read.table('ClosestCluster.tsv', header=T)
