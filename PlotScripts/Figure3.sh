...
data <- read.table('/project/scRNA/SourceData/XEcto_fraction.tsv', header=T)
...
data <- read.table('/project/scRNA/SourceData/Cdkn2a_pos_cells.tsv', header=T)
...
WT_plot <- read.table('/project/scRNA/SourceData/Dppa3_Umap_WT.tsv', header=T)
Eed_plot <- read.table('/project/scRNA/SourceData/Dppa3_Umap_Eed.tsv', header=T)
Rnf2_plot <- read.table('/project/scRNA/SourceData/Dppa3_Umap_Rnf2.tsv', header=T)
Kdm2b_plot <- read.table('/project/scRNA/SourceData/Dppa3_Umap_Kdm2b.tsv', header=T)
