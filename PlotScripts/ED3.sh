...
data <- read.table('PCA_embryo_WT.tsv', header=T)
...
data <- read.table('PCA_median_WT.tsv', header=T)
...
dataWT <- read.table('PCA_median_WT.tsv', header=T)
dataKO <- read.table('PCA_embryo_KO.tsv', header=T)
...
data <- read.table('CellStateFraction_diff_expr_E.tsv', header=T)
...
data <- read.table('CellStateFraction_diff_expr_X.tsv', header=T)
